  ...
  return (
    ...
    <div
      ...
      <MotionSlider className={ '' } delay={ 1.2 }>
        ...
        >
          <motion.div
            className={ `bg-gradient-to-b bg-slate-300 rounded-lg text-slate-950 py-3 px-7 min-w-[230px] text-3xl cursor-pointer border-2 border-black shadow-xl hover:shadow-2xl w-full sm:w-auto my-2 text-center ${ inter_tightHeavy.className }` }
