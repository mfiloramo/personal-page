      ...
      <div className={'bg-darkblue-grid-background section-shadow pt-1'}>
        <MotionSlider
          ...
          <div className={'px-8'}>
            ...
            <p className={'text-xl'}>I chose this stack to leverage a modern, scalable and developer-friendly ecosystem that ensures fast development, easy maintenance and seamless deployment.</p>
