...
export default function Portfolio(): ReactElement {
  return (
    <div className='relative flex flex-col w-screen mx-auto lg:p-0 px-8 pt-4'>
      <div className={ 'mx-auto max-w-screen-md drop-shadow-in-top' }>
        ...
        <MotionSlider className={ `text-sky-300 text-2xl ${ cabinLight.className }` } delay={ 0.4 }>
          <p>
            I've showcased here a spectrum of projects, from practical and responsive tools to dynamic websites and
      ...
      <div className={ 'mt-10 bg-gradient-to-r from-sky-950 via-blue-950 to-purple-950 shadow-[inset_0_6px_20px_rgba(0,0,0,0.6)]' }>
        <MotionSlider delay={ 1 } className={ 'z-10' }>

          {/* LOGO CONTAINER */ }
          <div className={ 'w-full h-fit p-4 z-20 mt-4 mb-12 flex flex-col sm:flex-row justify-around max-w-screen-md mx-auto' }>
