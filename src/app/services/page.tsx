  ...
  return (
    <div className='relative flex flex-col sm:mx-auto'>
      ...
      <div className={ 'mt-4 w-full bg-gradient-to-b from-slate-200 to-slate-400 h-fit section-shadow pb-8' }>
        ...
        <div className={ 'grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-7 justify-items-center max-w-md sm:max-w-screen-xl mx-auto mt-7 px-6 gap-y-1' }>
